...
class Computeloss:
    ...
    def __init__(self, anchors, cls_num = 20, device = "cuda") -> None:
        self.device = device
        self.anchors = anchors
        self.cls_num = cls_num
        self.max_anchor = 4
        self.BCEcls = nn.BCEWithLogitsLoss(pos_weight = 0.5)
        self.BCEconf = nn.BCEWithLogitsLoss(pos_weight = 0.67198)
    ...
    def __call__(self, p, targets):
        ...
        for i, pi in enumerate(p):
            ...
            if n:
                ...
                iou = CIOU(box, targets_box).squeeze()
